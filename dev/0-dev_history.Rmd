...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Traitement des données de trafic à Paris",
    Description = "Fonctions et données historiques autour des données des compteurs en opendata.",
    `Authors@R` = c(
...
```{r}
usethis::use_data_raw(name="Donnees")
```
